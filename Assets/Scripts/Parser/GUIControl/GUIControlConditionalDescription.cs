...
public class GUIControlConditionalDescription : GUIControlDescription
{
    ...
    public GUIControlConditionalDescription(BinaryReader2 reader)
    {
        Internalize(reader);
    }
    ...
    private void Internalize(BinaryReader2 reader)
    {
        ...
        List<GUIControlDescription> condValuesWithCases = GUIControlListReader.InternalizeControls(reader);
